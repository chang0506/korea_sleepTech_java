...
// == 도서 관리 시스템 == //
// : 책의 정보를 저장, 책의 상(대여 가능 여부) 확인, 책의 정보 출력

// 1) Book 클래스
// : 속성) title(String, 불변성), author(String, 불변성), isAvailable (Boolean)
// : 메서드) borrowBook(), returnBoook(), displayInfo()
...
public class D_OOP_prac {
	public static void main(String[] args) {
		...
		book1.displayInfo(); // 제목: 역사의 쓸모, 저자: 최태성, 대여 가능 여부: 대여 가능
		book1.borrowBook(); // 책 대여가 성공적으로 완료되었습니다.
		book1.displayInfo(); // 제목: 역사의 쓸모, 저자: 최태성, 대여 가능 여부: 대여 중
