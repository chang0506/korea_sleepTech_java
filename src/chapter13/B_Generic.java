...
public class B_Generic {
	public static void main(String[] args) {
		...
		Basket<Integer> integeringBasket = new Basket<>(); // 글자를 담는 바구니
		integeringBasket.setItem(777);
		System.out.println(integeringBasket.getItem()); // 777
