...
public class StudentManagemetApp {
...
//		Student student1 = new Student(1, "전창현", 27, "슬립테크", 4.0);
//		Student student2 = new Student(2, "전창현1", 27, "슬립테크", 4.0);
//		Student student3 = new Student(3, "전창현2", 27, "슬립테크", 4.0);
//		Student student4 = new Student(4, "전창현3", 27, "슬립테크", 4.0);
//		Student student5 = new Student(5, "전창현4", 27, "슬립테크", 4.0);
//		
...
//		student1.printStudentInfo();
		...
		// 학생 추가
		addStudent(1, "전창현", 27, "슬립테크", 4.0);
		addStudent(2, "전창현1", 21, "슬립테크", 4.1);
		addStudent(3, "전창현2", 22, "슬립테크", 4.2);
		addStudent(4, "전창현3", 23, "슬립테크", 4.3);
