...
public class G_Practice {
	public static void main(String[] args) {
		/*
		 * 단어 퀴즈 맞추기 게임 : 동적 배열에 단어 5개를 삽입
		 * 
		 * 무작위의 수를 생성(0~5)하여 단어 5개 중에서 1가지를 선택)
		 * 
		 * 사용자로부터 입력받은 값이 무작위로 선택된 단어와 일치할 경우 게임 종료 , 정답을 맞출 때까지 무한 반복 +) "종료" 입력 시 프로그램
		 * 종료
		 * 
		 */
		...
		int index = rn.nextInt(items.size()); // 0 부터 5 미만까지의 정수 (items의 인덱스 번호)
