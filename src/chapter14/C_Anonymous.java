...
public class C_Anonymous {
	public static void main(String[] args) {
		Student student1 = new Student("전창현1", 100);
		Student student2 = new Student("전창현2", 90);
		Student student3 = new Student("전창현3", 80);
		Student student4 = new Student("전창현4", 70);
		Student student5 = new Student("전창현5", 60);
