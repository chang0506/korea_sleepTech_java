...
public class E_Lambda {
	public static void main(String[] args) {
		...
		// 기본 조건 검사
		System.out.println(isEven.test(10)); // t
		System.out.println(isPositive.test(-10)); // f
		
		// 짝수이면서 양수인 경우를 검사
		Predicate<Integer> isEvenAndPositive = isEven.and(isPositive);
		System.out.println(isEvenAndPositive.test(4)); // t
		System.out.println(isEvenAndPositive.test(-4)); // f
		...
		System.out.println(stringLength.apply("테스트 코드"));
